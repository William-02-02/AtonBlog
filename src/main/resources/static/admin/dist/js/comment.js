$(function () {
    ...
    function statusFormatter(cellvalue) {
        if (cellvalue == 0) {
            ...
            return "<button type=\"button\" class=\"btn btn-block btn-danger btn-sm\" style=\"width: 80%;\">复审中</button>";
        }
    }
...
function commentSearch() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: '/admin/comments/list'}).trigger("reloadGrid");
}
